    ...
    <main>
        <div id="main-content" class="container-fluid">
                ...
                <div class="tab-content" id="mindmap-TabContent">
                    <div class="tab-pane fade show active" id="mindmap" role="tabpanel">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <button type="button" class="btn btn-primary" onclick="checkMindMap()">
                        ...
                        <div>
                            ...
                            <button id="mindmap-save-btn" class="btn btn-primary" onclick="saveNewMindMap()">Save</button>
                            <button id="mindmap-update-btn" class="btn btn-primary" onclick="updateMindMap()">Update</button>                        
                            <button id="mindmap-delete-btn" class="btn btn-primary" onclick="deleteMindMap()">Delete</button>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="mindmap-node" role="tabpanel">
                        <div class="list-group" id="list-mind-node">
            ...
            <div id="mindmap-image" class="col-9">
                <div>
                    <img id="mindmap-image-el" src="/Management/resource/images/mindmap.png" alt="" onclick="showNodeContent(event)"
